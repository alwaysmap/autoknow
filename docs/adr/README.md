...
| [0008](0008-npm-ci-bootstraps-a-checkout-but-nothing-depends-on-it.md) | `npm ci` bootstraps a checkout — and CI and Docker never depend on that | accepted | dev-loop, ci, docker, env |
