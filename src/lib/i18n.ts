...
const STRINGS = {
  ...
  relScore3: { en: 'Fragile', de: 'Fragil', ja: '不安定', ko: '불안정' },
  relScore4: { en: 'Steady', de: 'Stabil', ja: '安定', ko: '안정' },
  relScore5: { en: 'Solid', de: 'Solide', ja: '堅実', ko: '견고' },
  relScore6: { en: 'Strong', de: 'Stark', ja: '強固', ko: '강력' },
  relScore7: { en: 'Exemplary', de: 'Vorbildlich', ja: '模範的', ko: '모범적' },
  ...
  relScaleHint: { en: '1 = critical · 7 = exemplary', de: '1 = kritisch · 7 = vorbildlich', ja: '1 = 危機的 · 7 = 模範的', ko: '1 = 위기 · 7 = 모범적' },
  relScoreAria: { en: 'Relationship score, 1 to 7', de: 'Beziehungswert, 1 bis 7', ja: '関係スコア（1〜7）', ko: '관계 점수, 1~7' },
