...
const STRINGS = {
  ...
  capacityTitle: {
    en: 'Units online over time',
    de: 'Einheiten online über die Zeit',
    ja: '稼働台数の推移',
    ko: '시간에 따른 가동 대수',
  },
  capacityWithGas: { en: 'with GAS', de: 'mit GAS', ja: 'GASあり', ko: 'GAS 포함' },
  capacityWithoutGas: { en: 'without GAS', de: 'ohne GAS', ja: 'GASなし', ko: 'GAS 미포함' },
  capacityExcluded: {
  ...
  // ---- program brief ----
  programBrief: { en: 'Program brief', de: 'Programm-Brief', ja: 'プログラムブリーフ', ko: '프로그램 브리프' },
  briefsOffPrefix: {
    en: 'AI briefs are off — no Gemini API key is configured. Set',
    de: 'KI-Briefs sind aus — kein Gemini-API-Schlüssel konfiguriert. Setze',
    ja: 'AIブリーフは無効です — Gemini APIキーが未設定です。',
    ko: 'AI 브리프가 꺼져 있습니다 — Gemini API 키가 설정되지 않았습니다.',
  },
  briefsOffSuffix: {
    en: "to enable a daily synthesized summary of this program's updates.",
    de: 'um eine tägliche zusammengefasste Übersicht der Updates dieses Programms zu aktivieren.',
    ja: 'を設定すると、このプログラムの更新の日次要約が有効になります。',
    ko: '를 설정하면 이 프로그램 업데이트의 일일 요약이 활성화됩니다.',
  },
  briefEmpty: {
    en: "No brief yet. Generate one to get a synthesized read of this program's recent needle and phase updates, risks, decisions, and partner activity.",
    de: 'Noch kein Brief. Erstelle einen, um eine zusammengefasste Sicht auf aktuelle Nadel- und Phasen-Updates, Risiken, Entscheidungen und Partneraktivität zu erhalten.',
    ja: 'ブリーフはまだありません。生成すると、最近のニードル・フェーズ更新、リスク、意思決定、パートナー活動の要約が得られます。',
    ko: '아직 브리프가 없습니다. 생성하면 최근 니들·단계 업데이트, 리스크, 의사결정, 파트너 활동의 요약을 볼 수 있습니다.',
  },
  briefProvenance: {
    en: 'Generated {d} by Gemini · from {n} records',
    de: 'Erstellt {d} von Gemini · aus {n} Einträgen',
    ja: '{d} Gemini生成 · {n}件のレコードから',
    ko: '{d} Gemini 생성 · 레코드 {n}건 기반',
  },
  briefStale: { en: '· new activity since', de: '· seitdem neue Aktivität', ja: '· その後に新しいアクティビティあり', ko: '· 이후 새 활동 있음' },
  ...
  // ---- SOP chart ----
  sopChartTitle: { en: 'Industry SOP & Volume Target Timeline', de: 'Branchen-SOP- & Volumenziel-Zeitachse', ja: '業界SOP・目標台数タイムライン', ko: '업계 SOP 및 목표 물량 타임라인' },
  sopChartEmpty: {
  ...
  allSops: { en: 'All SOPs', de: 'Alle SOPs', ja: 'すべてのSOP', ko: '모든 SOP' },
  inFlightOnly: { en: 'In Flight Only', de: 'Nur laufende', ja: '進行中のみ', ko: '진행 중만' },
  unitsPerYearAxis: { en: 'Units/Yr (SOP)', de: 'Einheiten/Jahr (SOP)', ja: '台数/年（SOP）', ko: '대수/년 (SOP)' },
  cumVolumeAxis: { en: 'Cum. Volume (Industry)', de: 'Kum. Volumen (Branche)', ja: '累計台数（業界）', ko: '누적 물량 (업계)' },
  launched: { en: 'Launched', de: 'Gestartet', ja: 'ローンチ済み', ko: '출시됨' },
  inFlight: { en: 'In Flight', de: 'Laufend', ja: '進行中', ko: '진행 중' },
  targetSop: { en: 'Target SOP:', de: 'SOP-Ziel:', ja: '目標SOP:', ko: '목표 SOP:' },
  volSep: { en: '| Vol:', de: '| Vol.:', ja: '| 台数:', ko: '| 물량:' },
  unitsPerYr: { en: '{n} units/yr', de: '{n} Einheiten/Jahr', ja: '{n}台/年', ko: '{n}대/년' },
  sopHoverHint: {
  ...
  targetLaunchTimeline: { en: 'Target Launch Timeline (SOP)', de: 'Ziel-Startzeitplan (SOP)', ja: '目標ローンチタイムライン（SOP）', ko: '목표 출시 타임라인 (SOP)' },
  aiStatusSynthesis: { en: 'AI Status Synthesis', de: 'KI-Status-Synthese', ja: 'AIステータス統合', ko: 'AI 상태 종합' },
  geminiSynthesisReport: { en: 'Gemini Synthesis Report', de: 'Gemini-Synthesebericht', ja: 'Gemini統合レポート', ko: 'Gemini 종합 리포트' },
  liveFeedsCompiled: { en: 'Live feeds compiled', de: 'Live-Feeds zusammengestellt', ja: 'ライブフィードを集約', ko: '실시간 피드 취합됨' },
  noWebhookUpdates: { en: 'No active Google Chat webhook updates ingested yet.', de: 'Noch keine Google Chat-Webhook-Updates erfasst.', ja: 'Google ChatのWebhook更新はまだ取り込まれていません。', ko: '아직 수집된 Google Chat 웹훅 업데이트가 없습니다.' },
  executiveBlockerSummary: { en: 'Executive Blocker Summary:', de: 'Blocker-Übersicht für die Leitung:', ja: 'エグゼクティブ・ブロッカー要約:', ko: '경영진 블로커 요약:' },
  ...
  noCareerHistory: { en: 'No career history found for this person.', de: 'Kein Werdegang für diese Person gefunden.', ja: 'この人物の職歴は見つかりません。', ko: '이 사람의 경력 이력이 없습니다.' },
  ...
  seedCoreDesc: {
    en: 'Seeds baseline production lookup data (e.g. Regions, Partner Types, Google LLC). Use this to start with a fresh app that is ready for manual data entry.',
    de: 'Spielt grundlegende Produktions-Stammdaten ein (z. B. Regionen, Partnertypen, Google LLC). Für einen frischen Start mit manueller Dateneingabe.',
    ja: '基本の本番ルックアップデータ（リージョン、パートナー種別、Google LLCなど）を投入します。手動データ入力の準備が整った新しいアプリで始める場合に使用します。',
    ko: '기본 프로덕션 조회 데이터(지역, 파트너 유형, Google LLC 등)를 시드합니다. 수동 데이터 입력이 가능한 새 앱으로 시작할 때 사용하세요.',
  },
