...
const STRINGS = {
  ...
  gatingProgramCount: { en: 'gating 1 program', de: 'blockiert 1 Programm', ja: '1件のプログラムを律速', ko: '1개 프로그램을 제약' },
  gatingProgramsCount: { en: 'gating {n} programs', de: 'blockiert {n} Programme', ja: '{n}件のプログラムを律速', ko: '{n}개 프로그램을 제약' },
